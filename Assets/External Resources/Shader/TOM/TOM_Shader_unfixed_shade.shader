Shader "Custom/TOM_unfixed_shade"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                //ライトの影響を反映する
                float3 lighting1 = albedo.rgb * _LimShadeColor1 * limShadePower  * _LimShadeColorWeight1 * light.color.rgb;
                col.rgb += lighting1;
                ...
                //ライトの影響を反映する
                float3 lighting2 = albedo.rgb * _LimShadeColor2 * limShadePower  * _LimShadeColorWeight2 * light.color.rgb;
                col.rgb += lighting2;
                ...
                float lightingMask = albedo.rgb * limShadePower * light.color.rgb;
                col.rgb += lightingMask;
